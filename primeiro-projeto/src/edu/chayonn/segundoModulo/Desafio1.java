...
public class Desafio1 {
    ...
    public static void main(String[] args) {
    	...
    	for (int i = 0; i < N; i++) {
    		...
    		else if (jogador2.equalsIgnoreCase("papel") && jogador1.equalsIgnoreCase("pedra")) System.out.println("Jogaqdor 1 venceu");
    		else if (jogador1.equalsIgnoreCase("papel") && jogador2.equalsIgnoreCase("ataque")) System.out.println("Jogador 2 venceu");
    		else System.out.println("Não houve ganhador");
    	}
